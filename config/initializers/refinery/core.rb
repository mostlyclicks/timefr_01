...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "TIME Sport - Carbon Fiber Bicycle Frames and Pedals - Handmade in France"

  # This activates Google Analytics tracking within your website. If this
  # config is left blank or set to UA-xxxxxx-x then no remote calls to
  # Google Analytics are made.
  config.google_analytics_page_code = "UA-21814715-1"
  ...
  # config.dragonfly_secret = "10a443130584f9e099366ef4cae948e332cefa82ef0e2f31"
